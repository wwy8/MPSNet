...
parser.add_argument('--model_id', type=str, default='ETTh1_720_96', help='model id')
parser.add_argument('--model', type=str, default='DuFP', help='model name,SparseTSF or DuFP  version2plus')
...
# HARMON
parser.add_argument('--period_lens', type=list, default=[4, 8, 12, 24, 48], help='period lengths')
parser.add_argument('--cluster_k', type=int, default=20, help='cluster number')
...
parser.add_argument('--rec_lambda', type=float, default=0.25, help='weight of reconstruction function')
parser.add_argument('--auxi_lambda', type=float, default=0.05, help='weight of auxilary function')
...
if args.is_training:
    for ii in range(args.itr):
        # random.seed(fix_seed_list)
        # torch.manual_seed(fix_seed_list)
        # np.random.seed(fix_seed_list)
        # setting record of experiments
        setting = '{}_{}_{}_ft{}_freq{}_sl{}_pl{}_{}_{}_{}_{}_seed{}'.format(
            args.model_id,
            args.model,
            args.data,
            args.features,
